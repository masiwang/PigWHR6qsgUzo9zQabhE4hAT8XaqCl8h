<div class="container-fluid" style="background: #222; color: #666">
    ...
    <div class="row p-4">
        <div class="col-md-6 px-4">
            <img src="/image/makarya-light-250x75.png" height="75px" alt="">
        ...
        <div class="col-md-6 px-4">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <img class="mb-1" style="border-radius:.5em" src="/image/mitech-button-google-play-light.jpg" alt=""/>
                    <img  style="border-radius:.5em" src="/image/mitech-button-app-store-light.jpg" alt=""/>
                </div>
            </div>
        </div>
    </div>
